...
class AnalisadorLexico{
    ...
    private Symbol semanticAction(String lexema){
        ...
        if(lexema.equals(SymbolTable.EOF)){
                    ...
                    case 8 :
                        if(c.matches("[a-z]|[0-9]|_")){
                            ...
                            if(lex.equals("false")){
                                s = FINAL_STATE;
                                this.readskip--; // Volta ao caractere lido no instante para ser consumido novamente
                                symbol = semanticAction(SymbolTable.CONSTANTE); // CONSTANTE FALSE
                            }else if(lex.equals("true")){
                                s = FINAL_STATE;
                                this.readskip--; // Volta ao caractere lido no instante para ser consumido novamente
                                symbol = semanticAction(SymbolTable.CONSTANTE); // CONSTANTE TRUE
                            }else{
                                s = FINAL_STATE;
                                this.readskip--; // Volta ao caractere lido no instante para ser consumido novamente
                                symbol = semanticAction(lex); // IDENTIFICADOR OU PALAVRA RESERVADA
